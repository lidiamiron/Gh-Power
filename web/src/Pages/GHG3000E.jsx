...
const ProductSpecs = () => {
  ...
  return (
    <div className="specs-container">
      <h2 className="specs-title">{t('ghg3000e.technicalSpecs')}</h2>

      <div className="specs-block">
        <div className="specs-header" onClick={() => toggleSection("estructura")}>
          <h3>{t('ghg3000e.structure')}</h3>
        ...
        {openSection === "estructura" && (
          <table className="specs-table">
            <tbody>
              <tr>
                <td>{t('ghg3000e.specs.structure')}</td>
                <td>{t('ghg3000e.specs.structureValue')}</td>
              </tr>
              <tr>
                <td>{t('ghg3000e.specs.dimensions')}</td>
                <td>{t('ghg3000e.specs.dimensionsValue')}</td>
              </tr>
              <tr>
                <td>{t('ghg3000e.specs.weight')}</td>
                <td>{t('ghg3000e.specs.weightValue')}</td>
              </tr>
            </tbody>
          </table>
        )}
      ...
      <div className="specs-block">
        <div className="specs-header" onClick={() => toggleSection("motor")}>
          <h3>{t('ghg3000e.motor')}</h3>
          <span>{openSection === "motor" ? "↑" : "↓"}</span>
        </div>
        {openSection === "motor" && (
          <ul className="specs-list">
            <li>{t('ghg3000e.specs.model')}</li>
            <li>{t('ghg3000e.specs.frequency')}</li>
            <li>{t('ghg3000e.specs.voltage')}</li>
            <li>{t('ghg3000e.specs.socketType')}</li>
            <li>{t('ghg3000e.specs.engineCapacity')}</li>
            <li>{t('ghg3000e.specs.dcOutput')}</li>
            <li>{t('ghg3000e.specs.phases')}</li>
            <li>{t('ghg3000e.specs.startingSystem')}</li>
            <li>{t('ghg3000e.specs.engineCooling')}</li>
            <li>{t('ghg3000e.specs.autonomy')}</li>
            <li>{t('ghg3000e.specs.battery')}</li>
          </ul>
        )}
      </div>
      ...
      <div className="docs-block">
        ...
        <div className="doc-item">
          <a href="https://mfbwfvyokxanubyxamim.supabase.co/storage/v1/object/sign/Fichas%20Tecnicas/GHG3000E.pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV84YjE0MGYwNC01ZTNkLTRhYzItOGQ3OS02ZWI3YzMzNjNjNDUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJGaWNoYXMgVGVjbmljYXMvR0hHMzAwMEUucGRmIiwiaWF0IjoxNzU4MDIzOTU4LCJleHAiOjIzODg3NDM5NTh9.IjGfaCaC1AXzkTppkBI-Le--UGGGJo5qpNfGHH08d5U" className="pdf-icon" title={t('ghg3000e.techSheet')}>
            <FaFilePdf />
          </a>
          <a href="https://mfbwfvyokxanubyxamim.supabase.co/storage/v1/object/sign/Fichas%20Tecnicas/GHG3000E.pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV84YjE0MGYwNC01ZTNkLTRhYzItOGQ3OS02ZWI3YzMzNjNjNDUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJGaWNoYXMgVGVjbmljYXMvR0hHMzAwMEUucGRmIiwiaWF0IjoxNzU4MDIzOTU4LCJleHAiOjIzODg3NDM5NTh9.IjGfaCaC1AXzkTppkBI-Le--UGGGJo5qpNfGHH08d5U" target="_blank" rel="noreferrer" title={t('ghg3000e.techSheet')}>
  ...
  return (
    <section className="gallery-section" ref={sectionRef}>
      <Helmet>
        ...
        <meta
          name="description"
          content="Generador portátil GHG3000E de GH Power: máxima potencia y fiabilidad para uso doméstico y profesional. Pide presupuesto ahora."
        />
        <meta
          name="keywords"
        ...
        <meta
          ...
          content="Descubre el generador portátil GHG3000E de GH Power, ideal para uso doméstico y profesional. Pide presupuesto hoy."
        />
      ...
      <div className="gallery-right">
        <h2 className="product-title">{t('ghg3000e.title')}</h2>
        <p className="product-subtitle">{t('ghg3000e.subtitle')}</p>
        <ul className="product-info">
          <li>{t('ghg3000e.features.powerPRP')}</li>
          <li>{t('ghg3000e.features.powerESP')}</li>
          <li>{t('ghg3000e.features.singlePhase')}</li>
          <li>{t('ghg3000e.features.weight')}</li>
          <li>{t('ghg3000e.features.engine')}</li>
          <li>{t('ghg3000e.features.alternator')}</li>
          <li>{t('ghg3000e.features.fuelCapacity')}</li>
        </ul>
        <a href="/Contacto">
          <button className="product-button">
            {t('ghg3000e.contactButton')}
          </button>
        </a>
      </div>
    </section>
