        ...
        {openSection === "estructura" && (
          <table className="specs-table">
            <tbody>
              ...
              <tr><td>Dimensiones:</td><td>715 x 540 x 545 mm</td></tr>
              <tr><td>Peso neto:</td><td>150 kg</td></tr>
  ...
  return (
    <section className="gallery-section" ref={sectionRef}>
      ...
      <div className="gallery-right">
        <h2 className="product-title">GHG10000E</h2>
        <p className="product-subtitle">Monofásico</p>
        <ul className="product-info">
          <li>⚡ Potencia PRP: 8.0kW / 8.5kVA</li>
          <li>⚡ Potencia ESP: 8.5kW / 9.0kVA</li>
          <li>🔌 Monofásico</li>
          <li>⚖️ 150 Kg</li>
          <li>✔️ Motor GE460VE</li>
