  ...
  return (
    <section className="gallery-section" ref={sectionRef}>
      ...
      <div className="gallery-right">
        <h2 className="product-title">GHD13500E</h2>
        <p className="product-subtitle">Monofásico</p>
        <ul className="product-info">
          <li>⚡ Potencia PRP: 9.0kW / 10kVA</li>
          <li>⚡ Potencia ESP: 10kW / 11kVA</li>
          <li>🔌 Monofásico</li>
          <li>⚖️ 150 Kg</li>
          <li>✔️ Motor DE1102FE</li>
