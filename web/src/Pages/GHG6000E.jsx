        ...
        {openSection === "estructura" && (
          <table className="specs-table">
            <tbody>
              ...
              <tr><td>Peso neto:</td><td>83/87 kg</td></tr>
  ...
  return (
    <section className="gallery-section" ref={sectionRef}>
      ...
      <div className="gallery-right">
        <h2 className="product-title">GHG6000E</h2>
        <p className="product-subtitle">Monofásico</p>
        <ul className="product-info">
          <li>⚡ Potencia PRP: 5.0kW / 5.5kVA</li>
          <li>⚡ Potencia ESP: 5.5kW / 6.0kVA</li>
          <li>🔌 Monofásico</li>
          <li>⚖️ 83/87 Kg</li>
          <li>✔️ Motor GE390E</li>
