    ...
    <div className="specs-container">
      ...
      <div className="docs-block">
        ...
        <div className="doc-item">
          <a href="/docs/LK21B.pdf" className="pdf-icon" title={t('ghg7000e.techSheet')}>
            <FaFilePdf />
          </a>
          <a href="/docs/LK21B.pdf" target="_blank" rel="noreferrer" title={t('ghg7000e.techSheet')}>
  ...
  return (
    <section className="gallery-section" ref={sectionRef}>
      <Helmet>
        ...
        <meta
          name="description"
          content="Generador portátil GHG7000E de GH Power: máxima potencia y fiabilidad para uso doméstico y profesional. Cotiza ahora."
        />
        <meta
          name="keywords"
        ...
        <meta
          ...
          content="Descubre el generador portátil GHG7000E de GH Power, ideal para uso doméstico y profesional. Cotiza hoy."
        />
