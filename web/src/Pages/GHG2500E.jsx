        ...
        {openSection === "estructura" && (
          <table className="specs-table">
            <tbody>
              ...
              <tr><td>Peso neto:</td><td>41.5/44.5 kg</td></tr>
  ...
  return (
    <section className="gallery-section" ref={sectionRef}>
      ...
      <div className="gallery-right">
        <h2 className="product-title">GHG2500E</h2>
        <p className="product-subtitle">Monofásico</p>
        <ul className="product-info">
          <li>⚡ Potencia PRP: 2.0kW / 2.2kVA</li>
          <li>⚡ Potencia ESP: 2.2kW / 2.5kVA</li>
          <li>🔌 Monofásico</li>
          <li>⚖️ 41.5/44.5 Kg</li>
          <li>✔️ Motor GE200E</li>
          <li>✔️ Alternador de alto rendimiento</li>
          <li>✔️ Capacidad de combustible: 12 L</li>
        </ul>
