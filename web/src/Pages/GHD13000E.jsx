        ...
        {openSection === "estructura" && (
          <table className="specs-table">
            <tbody>
              ...
              <tr><td>Peso neto:</td><td>134 kg</td></tr>
  ...
  return (
    <section className="gallery-section" ref={sectionRef}>
      ...
      <div className="gallery-right">
        <h2 className="product-title">GHD13000E</h2>
        <p className="product-subtitle">Monofásico</p>
        <ul className="product-info">
          <li>⚡ Potencia PRP: 8.0kW / 8.8kVA</li>
          <li>⚡ Potencia ESP: 9.0kW / 10kVA</li>
          <li>🔌 Monofásico</li>
          <li>⚖️ 134 Kg</li>
          <li>✔️ Motor DE198FE</li>
