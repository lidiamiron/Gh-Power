        ...
        {openSection === "estructura" && (
          <table className="specs-table">
            <tbody>
              ...
              <tr><td>Peso neto:</td><td>98/102 kg</td></tr>
  ...
  return (
    <section className="gallery-section" ref={sectionRef}>
      ...
      <div className="gallery-right">
        <h2 className="product-title">GHG9000E</h2>
        <p className="product-subtitle">Monofásico</p>
        <ul className="product-info">
          <li>⚡ Potencia PRP: 7.0kW / 7.5kVA</li>
          <li>⚡ Potencia ESP: 7.5kW / 8.0kVA</li>
          <li>🔌 Monofásico</li>
          <li>⚖️ 98/102 Kg</li>
          <li>✔️ Motor GE460E</li>
