        ...
        {openSection === "estructura" && (
          <table className="specs-table">
            <tbody>
              ...
              <tr><td>Dimensiones:</td><td>650 x 480 x 550 mm</td></tr>
              <tr><td>Peso neto:</td><td>60 kg</td></tr>
  ...
  return (
    <section className="gallery-section" ref={sectionRef}>
      ...
      <div className="gallery-right">
        <h2 className="product-title">GHD2000E</h2>
        <p className="product-subtitle">Monofásico</p>
        <ul className="product-info">
          <li>⚡ Potencia PRP: 1.8kW / 2.0kVA</li>
          <li>⚡ Potencia ESP: 2.0kW / 2.2kVA</li>
          <li>🔌 Monofásico</li>
          <li>⚖️ 60 Kg</li>
          <li>✔️ Motor DE170FE</li>
