        ...
        {openSection === "estructura" && (
          <table className="specs-table">
            <tbody>
              ...
              <tr><td>Dimensiones:</td><td>700 x 480 x 590 mm</td></tr>
              <tr><td>Peso neto:</td><td>70 kg</td></tr>
  ...
  return (
    <section className="gallery-section" ref={sectionRef}>
      ...
      <div className="gallery-right">
        <h2 className="product-title">GHD3000E</h2>
        <p className="product-subtitle">Monofásico</p>
        <ul className="product-info">
          <li>⚡ Potencia PRP: 2.8kW / 3.0kVA</li>
          <li>⚡ Potencia ESP: 3.0kW / 3.3kVA</li>
          <li>🔌 Monofásico</li>
          <li>⚖️ 70 Kg</li>
          <li>✔️ Motor DE178FE</li>
