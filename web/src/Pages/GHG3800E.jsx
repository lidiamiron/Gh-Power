        ...
        {openSection === "estructura" && (
          <table className="specs-table">
            <tbody>
              ...
              <tr><td>Peso neto:</td><td>48/50 kg</td></tr>
  ...
  return (
    <section className="gallery-section" ref={sectionRef}>
      ...
      <div className="gallery-right">
        <h2 className="product-title">GHG3800E</h2>
        <p className="product-subtitle">Monofásico</p>
        <ul className="product-info">
          <li>⚡ Potencia PRP: 3.2kW / 4.0kVA</li>
          <li>⚡ Potencia ESP: 3.5kW / 4.0kVA</li>
          <li>🔌 Monofásico</li>
          <li>⚖️ 48/50 Kg</li>
          <li>✔️ Motor GE225VE</li>
